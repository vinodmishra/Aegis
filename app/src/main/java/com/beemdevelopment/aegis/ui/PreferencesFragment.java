    ...
    private class RegisterBiometricsListener implements BiometricSlotInitializer.Listener {
        ...
        public void onInitializeSlot(BiometricSlot slot, Cipher cipher) {
            ...
            try {
                ...
                onSlotInitializationFailed(e.toString());
                return;
            }
        ...
        @Override
        public void onSlotInitializationFailed(@NonNull CharSequence errString) {
            Toast.makeText(getActivity(), getString(R.string.encryption_enable_biometrics_error) + errString, Toast.LENGTH_LONG).show();
        }
    }
